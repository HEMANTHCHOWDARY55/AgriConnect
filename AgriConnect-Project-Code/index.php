...
?>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1><?php echo $config['PROJECT_TITLE']; ?> - <?php echo $config['PROJECT_TAGLINE']; ?>...</h1>
      <h2>AgriConnect System mainly helps to farmers,customers,workers...</h2>
...
<img src="img/pja1.jpg" style="width: 100%;">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <p class="font-italic"><b>Vision :</b> To provide a helping hand to the farmers,customers and farm labourers in improving their lives through the medium of technology, thereby, improving the Agricultural Sector in the Indian Economy.
            </p>
            <ul>
